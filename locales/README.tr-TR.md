...
<div align='center'>
<a href="https://trendshift.io/repositories/2415" target="_blank"><img src="https://trendshift.io/api/badge/repositories/2415" alt="iteasoft%2FAnyZearch | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>

<p align="center">
<b>AnyZearch:</b> Aradığınız hepsi bir arada yapay zeka uygulaması.<br />
...
<p align="center">
  ...
  <a href="https://docs.anythingllm.com" target="_blank">
   ...
   <a href="https://my.mintplexlabs.com/aio-checkout?product=AnyZearch" target="_blank">
    Hosted Instance
  </a>
</p>
...
<p align="center">  
👉 Masaüstü için AnyZearch (Mac, Windows ve Linux)! <a href="https://anythingllm.com/download" target="_blank"> Şimdi İndir</a>  
</p>  
...
![Mesajlaşma](https://github.com/iteasoft/AnyZearch/assets/16845892/cfc5f47c-bd91-4067-986c-f3f49621a859)
...
- 💬 [Web sitenize gömülebilir özel sohbet aracı](https://github.com/iteasoft/AnyZearch-embed/blob/main/README.md) _(Yalnızca Docker sürümünde)_  
...
- [xAI](https://x.ai/)
- [Novita AI (chat models)](https://novita.ai/model-api/product/llm-api?utm_source=github_AnyZearch&utm_medium=github_readme&utm_campaign=link)
- [PPIO](https://ppinfra.com?utm_source=github_AnyZearch)

**Embedder modelleri:**

- [AnyZearch Native Embedder](/server/storage/models/README.md) (default)
- [OpenAI](https://openai.com)
- [Azure OpenAI](https://azure.microsoft.com/en-us/products/ai-services/openai-service)
...
- [AnyZearch Built-in](https://github.com/iteasoft/AnyZearch/tree/master/server/storage/models#audiovideo-transcription) (default)
- [OpenAI](https://openai.com/)
...
- **`embed`**: [Web gömme widget’ı](https://github.com/iteasoft/AnyZearch-embed) oluşturma ve entegrasyonu için alt modül.  
- **`browser-extension`**: [Chrome tarayıcı eklentisi](https://github.com/iteasoft/AnyZearch-extension) için alt modül.

## 🛳 Kendi Sunucunuzda Barındırma  

Mintplex Labs ve topluluk, AnyZearch'i yerel olarak çalıştırmak için çeşitli dağıtım yöntemleri, betikler ve şablonlar sunmaktadır. Aşağıdaki tabloya göz atarak tercih ettiğiniz ortamda nasıl dağıtım yapabileceğinizi öğrenebilir veya otomatik dağıtım seçeneklerini keşfedebilirsiniz.
...
[veya Docker kullanmadan üretim ortamında AnyZearch kurun →](../BARE_METAL.md)  
...
_Bu uygulamalar Mintplex Labs tarafından yönetilmemektedir, ancak AnyZearch ile uyumludur. Burada listelenmeleri bir onay anlamına gelmez._  

- [Midori AI Alt Sistem Yöneticisi](https://io.midori-ai.xyz/subsystem/AnyZearch/) - Docker konteyner teknolojisini kullanarak yapay zeka sistemlerini verimli bir şekilde dağıtmanın pratik bir yolu.  
- [Coolify](https://coolify.io/docs/services/AnyZearch/) - Tek tıklamayla AnyZearch dağıtımı yapmanıza olanak tanır.  
- [GPTLocalhost for Microsoft Word](https://gptlocalhost.com/demo/) - AnyZearch’i Microsoft Word içinde kullanmanıza olanak tanıyan yerel bir Word eklentisi.

## Telemetri ve Gizlilik  

Mintplex Labs Inc. tarafından geliştirilen AnyZearch, anonim kullanım bilgilerini toplayan bir telemetri özelliği içermektedir.  

<details>  
<summary><kbd>AnyZearch için Telemetri ve Gizlilik hakkında daha fazla bilgi</kbd></summary>  

### Neden?  

Bu bilgileri, AnyZearch’in nasıl kullanıldığını anlamak, yeni özellikler ve hata düzeltmelerine öncelik vermek ve uygulamanın performansını ve kararlılığını iyileştirmek için kullanıyoruz.  
...
[Kaynak kodda tüm telemetri olaylarını görüntüle](https://github.com/search?q=repo%3Aiteasoft%2FAnyZearch%20.sendTelemetry\(&type=code)
...
[![AnyZearch contributors](https://contrib.rocks/image?repo=iteasoft/AnyZearch)](https://github.com/iteasoft/AnyZearch/graphs/contributors)  

[![Star History Chart](https://api.star-history.com/svg?repos=iteasoft/AnyZearch&type=Timeline)](https://star-history.com/#iteasoft/AnyZearch&Date)  
...
[profile-link]: https://github.com/iteasoft
[vector-admin]: https://github.com/iteasoft/vector-admin
[assistant-swarm]: https://github.com/iteasoft/openai-assistant-swarm
...
[elestio-deploy]: https://elest.io/open-source/AnyZearch
