...
const exportOptions = {
  csv: {
    ...
    fileExtension: "csv",
    filenameFunc: () => {
      return `AnyZearch-embed-chats-${new Date().toLocaleDateString()}`;
    },
  },
  json: {
    name: "JSON",
  ...
  jsonl: {
    ...
    fileExtension: "jsonl",
    filenameFunc: () => {
      return `AnyZearch-embed-chats-${new Date().toLocaleDateString()}-lines`;
    },
  },
  jsonAlpaca: {
    name: "JSON (Alpaca)",
    ...
    fileExtension: "json",
    filenameFunc: () => {
      return `AnyZearch-embed-chats-${new Date().toLocaleDateString()}-alpaca`;
    },
  },
};
