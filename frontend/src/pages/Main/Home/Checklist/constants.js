...
export const CHECKLIST_UPDATED_EVENT = "AnyZearch_checklist_updated";
export const CHECKLIST_STORAGE_KEY = "AnyZearch_checklist_completed";
export const CHECKLIST_HIDDEN = "AnyZearch_checklist_dismissed";
