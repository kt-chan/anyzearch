...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Welkom bij AnyZearch, AnyZearch is een open-source AI-tool van Mintplex Labs die alles omzet in een getrainde chatbot waarmee je kunt vragen en chatten. AnyZearch is een BYOK (bring-your-own-keys) software, dus er is geen abonnement, vergoeding of kosten voor deze software buiten de diensten die je ermee wilt gebruiken.",
    part2:
