const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Bienvenido a AnyZearch, una herramienta de inteligencia artificial de código abierto creada por iteasoft labs que convierte cualquier cosa en un chatbot entrenado con el que puedes consultar y conversar. ",
    part2:
      "AnyZearch es la forma más sencilla de integrar productos de inteligencia artificial potentes como OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB y otros servicios en un paquete ordenado, sin complicaciones, para aumentar tu productividad en un 100x.",
    part3:
      "AnyZearch puede ejecutarse completamente en tu máquina local con poco impacto, ¡ni siquiera notarás que está ahí! No se necesita GPU. También está disponible la instalación en la nube y en instalaciones locales.\nEl ecosistema de herramientas de inteligencia artificial se vuelve más poderoso cada día. AnyZearch facilita su uso.",
  ...
  appearance: {
    ...
    message: {
      ...
      user: "usuario",
      message: "mensaje",
      assistant: "Asistente de chat AnyZearch",
  ...
  api: {
    title: "Claves API",
    description:
      "Las claves API permiten al titular acceder y gestionar programáticamente esta instancia de AnyZearch.",
  ...
  llm: {
    ...
    description:
      "Estas son las credenciales y configuraciones para tu proveedor preferido de chat y incrustación de LLM. Es importante que estas claves estén actualizadas y correctas, de lo contrario AnyZearch no funcionará correctamente.",
  ...
  transcription: {
    ...
    "warn-start":
      "El uso del modelo local Whisper en máquinas con RAM o CPU limitadas puede bloquear AnyZearch al procesar archivos multimedia.",
    "warn-recommend":
  ...
  embedding: {
    ...
    provider: {
      ...
      description:
        "No se requiere configuración cuando se utiliza el motor de incrustación nativo de AnyZearch.",
    },
  },
  ...
  vector: {
    ...
    description:
      "Estas son las credenciales y configuraciones para cómo funcionará tu instancia de AnyZearch. Es importante que estas claves estén actualizadas y correctas.",
    provider: {
  ...
  multi: {
    ...
    password: {
      ...
      description:
        "Protege tu instancia de AnyZearch con una contraseña. Si olvidas esta contraseña, no hay método de recuperación, así que asegúrate de guardar esta contraseña.",
    },
    instance: {
  ...
  privacy: {
    ...
    description:
      "Esta es tu configuración para cómo los proveedores de terceros conectados y AnyZearch manejan tus datos.",
