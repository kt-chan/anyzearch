...
const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "AnyZearch'e hoş geldiniz. AnyZearch, Mintplex Labs tarafından geliştirilen açık kaynaklı bir yapay zeka aracıdır ve her şeyi, sorgulayabileceğiniz ve sohbet edebileceğiniz eğitimli bir chatbota dönüştürür. AnyZearch, BYOK (kendi anahtarlarınızı getirin) yazılımıdır; bu nedenle, kullanmak istediğiniz hizmetler dışında herhangi bir abonelik, ücret ya da ek masraf yoktur.",
    part2:
      "AnyZearch, OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB ve benzeri güçlü yapay zeka ürünlerini zahmetsizce, düzenli bir paket içinde bir araya getirmenin en kolay yoludur; böylece verimliliğinizi 100 kat artırabilirsiniz.",
    part3:
      "AnyZearch tamamen yerel olarak makinenizde çok az kaynakla çalışabilir—orada olduğunu bile fark etmezsiniz! GPU gerekmez. Bulut veya şirket içi (on-premises) kurulum da mevcuttur.\nYapay zeka araç ekosistemi her geçen gün daha da güçleniyor. AnyZearch bu gücü kolayca kullanmanızı sağlar.",
  ...
  general: {
    ...
    message: {
      ...
      heading: "Bana açıkla",
      body: "AnyZearch'nin faydalarını",
    },
    pfp: {
  ...
  api: {
    ...
    description:
      "API anahtarları, bu AnyZearch örneğine programatik olarak erişmeye ve yönetmeye olanak tanır.",
  ...
  llm: {
    title: "LLM Tercihi",
    description:
      "Bu, tercih ettiğiniz LLM sohbet ve gömme sağlayıcısının kimlik bilgileri ile ayarlarıdır. Bu anahtarların güncel ve doğru olması önemlidir; aksi takdirde AnyZearch doğru çalışmayacaktır.",
  ...
  transcription: {
    ...
    "warn-start":
      "Sınırlı RAM veya CPU'ya sahip makinelerde yerel Whisper modelini kullanmak, medya dosyalarını işlerken AnyZearch'nin duraksamasına neden olabilir.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Gömme, metni vektörlere dönüştürme sürecidir. Dosyalarınızın ve komutlarınızın işlenebilmesi için AnyZearch, bu kimlik bilgilerine ihtiyaç duyar.",
    provider: {
  ...
  vector: {
    ...
    description:
      "AnyZearch örneğinizin nasıl çalışacağını belirleyen kimlik bilgileri ve ayarları burada bulunur. Bu anahtarların güncel ve doğru olması önemlidir.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Bağlantılı üçüncü taraf sağlayıcılarla ve AnyZearch ile verilerinizin nasıl ele alındığını burada yapılandırabilirsiniz.",
    llm: "LLM Seçimi",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "AnyZearch örneğinizi bir şifre ile koruyun. Bu şifreyi unutmanız hâlinde kurtarma yöntemi yoktur, bu yüzden mutlaka güvende saklayın.",
