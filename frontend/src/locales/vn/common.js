const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Chào mừng đến với AnyZearch, AnyZearch is an open-source AI tool by iteasoft Labs that turns anything into a trained chatbot you can query and chat with. AnyZearch is a BYOK (bring-your-own-keys) software so there is no subscription, fee, or charges for this software outside of the services you want to use with it.",
    part2:
  ...
  llm: {
    ...
    description:
      "These are the credentials and settings for your preferred LLM chat & embedding provider. Its important these keys are current and correct or else AnyZearch will not function properly.",
  ...
  embedding: {
    ...
    provider: {
      ...
      description:
        "There is no set up required when using AnyZearch's native embedding engine.",
    },
  },
