...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "AnyZearch var strādāt ar daudziem LLM pakalpojumu sniedzējiem. Šis būs pakalpojums, kas apstrādās sarunas.",
    },
    userSetup: {
    ...
    survey: {
      title: "Laipni lūgti AnyZearch",
      description:
        "Palīdziet mums veidot AnyZearch atbilstoši jūsu vajadzībām. Neobligāti.",
      email: "Kāds ir jūsu e-pasts?",
      useCase: "Kam izmantosiet AnyZearch?",
      useCaseWork: "Darbam",
      useCasePersonal: "Personīgai lietošanai",
      useCaseOther: "Citam nolūkam",
      comment: "Kā jūs uzzinājāt par AnyZearch?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Izveidojiet savu pirmo darba telpu un sāciet darbu ar AnyZearch.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Laipni lūgti AnyZearch, AnyZearch ir Mintplex Labs izstrādāts atvērtā koda AI rīks, kas pārvērš jebko par apmācītu čatbotu, kuru varat izmantot vaicājumiem un sarunām. AnyZearch ir BYOK (bring-your-own-keys) programmatūra, tāpēc nav abonēšanas, maksas vai papildu maksājumu par šo programmatūru, izņemot pakalpojumus, kurus vēlaties izmantot ar to.",
    part2:
      "AnyZearch ir vienkāršākais veids, kā apvienot spēcīgus AI produktus, piemēram, OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB un citus pakalpojumus, kārtīgā paketē bez liekas piepūles, lai palielinātu savu produktivitāti 100 reizes.",
    part3:
      "AnyZearch var darboties pilnībā lokāli jūsu datorā ar minimālu piepūli, jūs pat nepamanīsiet tā klātbūtni! GPU nav nepieciešams. Pieejama arī mākoņa un lokālā instalācija.\nAI rīku ekosistēma kļūst spēcīgāka ar katru dienu. AnyZearch to padara viegli izmantojamu.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Jūs esat ceļā, lai kļūtu par AnyZearch ekspertu!",
      dismiss: "aizvērt",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "Iestatiet savas UI preferences AnyZearch.",
    },
    branding: {
      title: "Zīmolrade un identitāte",
      description:
        "Pielāgojiet savu AnyZearch instanci ar pielāgotu zīmolradi.",
    },
    chat: {
      title: "Saruna",
      description: "Iestatiet savas sarunas preferences AnyZearch.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        ...
        description:
          "Izvēlieties vēlamo valodu AnyZearch lietotāja saskarnei - kad pieejami tulkojumi.",
      },
      logo: {
      ...
      "welcome-messages": {
        ...
        user: "lietotājs",
        message: "ziņojums",
        assistant: "AnyZearch čata asistents",
  ...
  api: {
    title: "API atslēgas",
    description:
      "API atslēgas ļauj to īpašniekam programmatiski piekļūt un pārvaldīt šo AnyZearch instanci.",
  ...
  llm: {
    title: "LLM preferences",
    description:
      "Šie ir akreditācijas dati un iestatījumi jūsu vēlamajam LLM čata un iegulšanas pakalpojuma sniedzējam. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas, pretējā gadījumā AnyZearch nedarbosies pareizi.",
  ...
  transcription: {
    ...
    "warn-start":
      "Izmantojot lokālo whisper modeli iekārtās ar ierobežotu RAM vai CPU var apstādināt AnyZearch, apstrādājot multivides failus.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Iegulšana ir process, ar kuru teksts tiek pārveidots vektoros. Šie akreditācijas dati ir nepieciešami, lai pārveidotu jūsu failus un vaicājumus formātā, kuru AnyZearch var izmantot apstrādei.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Šie ir akreditācijas dati un iestatījumi tam, kā darbosies jūsu AnyZearch instance. Ir svarīgi, lai šīs atslēgas būtu aktuālas un pareizas.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Šī ir jūsu konfigurācija tam, kā savienotie trešo pušu pakalpojumu sniedzēji un AnyZearch apstrādā jūsu datus.",
    llm: "LLM izvēle",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Šie faili tiks augšupielādēti dokumentu apstrādātājā, kas darbojas šajā AnyZearch instancē. Šie faili netiek nosūtīti vai kopīgoti ar trešo pusi.",
    },
    pinning: {
      what_pinning: "Kas ir dokumentu piespraušana?",
      pin_explained_block1:
        "Kad jūs <b>piespraudiet</b> dokumentu AnyZearch, mēs ievietosim visu dokumenta saturu jūsu uzvednes logā, lai jūsu LLM to pilnībā saprastu.",
      pin_explained_block2:
        "Tas vislabāk darbojas ar <b>liela konteksta modeļiem</b> vai maziem failiem, kas ir kritiski tā zināšanu bāzei.",
      pin_explained_block3:
        "Ja jūs nesaņemat vēlamās atbildes no AnyZearch pēc noklusējuma, tad piespraušana ir lielisks veids, kā iegūt kvalitatīvākas atbildes ar vienu klikšķi.",
      accept: "Labi, sapratu",
    },
    watching: {
      what_watching: "Ko dara dokumenta novērošana?",
      watch_explained_block1:
        "Kad jūs <b>novērojat</b> dokumentu AnyZearch, mēs <i>automātiski</i> sinhronizēsim jūsu dokumenta saturu no tā sākotnējā avota regulāros intervālos. Tas automātiski atjauninās saturu katrā darba vietā, kur šis fails tiek pārvaldīts.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Aizsargājiet savu AnyZearch instanci ar paroli. Ja aizmirsīsiet šo paroli, nav atgūšanas metodes, tāpēc pārliecinieties, ka saglabājat šo paroli.",
