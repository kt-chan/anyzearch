const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "歡迎使用 AnyZearch，AnyZearch 是由 iteasoft Labs 開發的開源 AI 工具，它能將任何內容轉換成可供查詢和對話的訓練模型對話機器人。AnyZearch 採用 BYOK（自備金鑰）軟體模式，除了您想使用的服務之外，本軟體不收取任何訂閱費、費用或其他費用。",
    part2:
  ...
  api: {
    title: "API 金鑰",
    description:
      "API 金鑰允許持有者以程式化方式存取和管理此 AnyZearch 系統。",
    link: "閱讀 API 文件",
  ...
  embedding: {
    ...
    provider: {
      title: "向量嵌入提供者",
      description: "使用 AnyZearch 的原生嵌入引擎時，不需要任何設定。",
    },
  },
