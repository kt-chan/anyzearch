const TRANSLATIONS = {
  ...
  welcomeMessage: {
    part1:
      "Добро пожаловать в AnyZearch, открытый инструмент искусственного интеллекта от iteasoft labs, который превращает что угодно в обученный чат-бот, с которым вы можете общаться и задавать вопросы. ",
    part2:
    ...
    contact: "Связаться с iteasoft labs",
  },
  ...
  appearance: {
    ...
    message: {
      ...
      user: "пользователь",
      message: "сообщение",
      assistant: "Чат-ассистент AnyZearch",
  ...
  embedding: {
    ...
    provider: {
      ...
      description:
        "Нет необходимости в настройке при использовании встроенного механизма встраивания AnyZearch.",
    },
  },
  text: {
