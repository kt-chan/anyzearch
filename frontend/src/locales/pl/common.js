...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "AnyZearch może współpracować z wieloma dostawcami modeli językowych",
    },
    userSetup: {
    ...
    survey: {
      title: "Witamy w AnyZearch",
      description:
        "Pomóż nam stworzyć AnyZearch dostosowany do Twoich potrzeb. Opcjonalnie.",
      email: "Jaki jest Twój adres e-mail?",
      useCase: "Do czego będziesz używać AnyZearch?",
      useCaseWork: "Do pracy",
      useCasePersonal: "Do użytku osobistego",
      useCaseOther: "Inne",
      comment: "Skąd dowiedziałeś się o AnyZearch?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Stwórz swój pierwszy obszar roboczy i zacznij korzystać z AnyZearch.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Witamy w AnyZearch, to narzędzie AI o otwartym kodzie źródłowym autorstwa Mintplex Labs, które zamienia wszystko w wyszkolonego chatbota, z którym można wysyłać zapytania i rozmawiać. AnyZearch to oprogramowanie BYOK (bring-your-own-keys), więc nie ma subskrypcji ani kosztów za to oprogramowanie poza usługami, których chcesz z nim używać.",
    part2:
      "AnyZearch to najprostszy sposób na połączenie potężnych produktów AI, takich jak OpenAi, GPT-4, LangChain, PineconeDB, ChromaDB i innych usług w zgrabny pakiet bez zbędnego zamieszania, aby zwiększyć produktywność 100-krotnie.",
    part3:
      "AnyZearch może działać całkowicie lokalnie na komputerze z niewielkim narzutem, nawet nie zauważysz, że tam jest! Nie jest wymagany procesor graficzny. Dostępna jest również instalacja w chmurze i lokalna. Ekosystem narzędzi AI staje się coraz potężniejszy każdego dnia. AnyZearch sprawia, że jest on łatwy w użyciu.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Jesteś na najlepszej drodze do zostania ekspertem AnyZearch!",
      dismiss: "zamknij",
      tasks: {
        create_workspace: {
  ...
  customization: {
    interface: {
      ...
      description: "Ustaw preferencje interfejsu użytkownika dla AnyZearch.",
    },
    branding: {
      title: "Branding i white-labeling",
      description:
        "Oznakuj swoją instancję AnyZearch niestandardowym brandingiem.",
    },
    chat: {
      title: "Czat",
      description: "Ustaw preferencje czatu dla AnyZearch.",
      auto_submit: {
    ...
    items: {
      ...
      "display-language": {
        title: "Język",
        description:
          "Wybierz preferowany język interfejsu użytkownika AnyZearch - jeśli dostępne są tłumaczenia.",
      },
      logo: {
        title: "Logo",
        description:
      ...
      "welcome-messages": {
        ...
        user: "użytkownika",
        message: "",
        assistant: "Asystent czatu AnyZearch",
  ...
  api: {
    title: "Klucze API",
    description:
      "Klucze API umożliwiają dostęp do instancji AnyZearch i zarządzanie nią.",
  ...
  llm: {
    ...
    description:
      "Tutaj skonfigurujesz dostawcę modeli językowych używanych do czatów i embeddingów. Upewnij się, że wszystkie klucze są aktualne i poprawne - bez tego AnyZearch nie będzie działać.",
  ...
  transcription: {
    ...
    "warn-start":
      "Korzystanie z lokalnego modelu Whisper na komputerach z ograniczoną pamięcią RAM lub procesorem może spowodować przerwanie pracy AnyZearch podczas przetwarzania plików multimedialnych.",
    "warn-recommend":
  ...
  vector: {
    ...
    description:
      "Tutaj skonfigurujesz wektorową bazę danych dla AnyZearch. Upewnij się, że wszystkie ustawienia są poprawne.",
    provider: {
      title: "Wektorowa baza danych",
  ...
  privacy: {
    ...
    description:
      "Jest to konfiguracja sposobu, w jaki połączeni dostawcy zewnętrzni i AnyZearch przetwarzają dane użytkownika.",
    llm: "Wybór LLM",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Pliki zostaną przetworzone w obrębie danej instancji AnyZearch. Pliki te nie będą udostępniane innym podmiotom.",
    },
    pinning: {
      what_pinning: "Czym jest przypinanie dokumentów?",
      pin_explained_block1:
        "Kiedy <b>przypinasz</b> dokument w AnyZearch, dodamy całą zawartość dokumentu do okna promptu, aby LLM mógł w pełni zrozumieć jego treść.",
      ...
      pin_explained_block3:
        "Jeśli domyślnie nie otrzymujesz pożądanych odpowiedzi z AnyZearch, przypinanie jest świetnym sposobem na uzyskanie wyższej jakości odpowiedzi za jednym kliknięciem.",
      accept: "Ok, rozumiem",
    },
    watching: {
      what_watching: "Do czego służy oglądanie dokumentu?",
      watch_explained_block1:
        "Podczas <b>obserwowania</b> dokumentu w AnyZearch będziemy <i>automatycznie</i> synchronizować zawartość dokumentu z jego oryginalnym źródłem w regularnych odstępach czasu. Spowoduje to automatyczną aktualizację zawartości w każdym obszarze roboczym, w którym ten plik jest zarządzany.",
    ...
    publish: {
      ...
      generic: {
        unauthenticated: {
          ...
          description:
            "Przed opublikowaniem elementów należy uwierzytelnić się w centrum społeczności AnyZearch.",
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Chroń swoją instancję AnyZearch hasłem. Jeśli go zapomnisz, nie ma metody odzyskiwania, więc upewnij się, że zapisałeś to hasło.",
