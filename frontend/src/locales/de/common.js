...
const TRANSLATIONS = {
  onboarding: {
    ...
    llm: {
      ...
      description:
        "AnyZearch ist mit vielen LLM-Anbietern kompatibel. Der ausgewählte Dienst wird für die Chats verwendet.",
    },
    userSetup: {
    ...
    survey: {
      title: "Willkommen bei AnyZearch",
      description:
        "Helfen Sie uns, AnyZearch an Ihre Bedürfnisse anzupassen. (Optional)",
      email: "Wie lautet Ihre E-Mail-Adresse?",
      useCase: "Wofür möchten Sie AnyZearch verwenden?",
      useCaseWork: "Beruflich",
      useCasePersonal: "Privat",
      useCaseOther: "Sonstiges",
      comment: "Wie haben Sie von AnyZearch erfahren?",
      commentPlaceholder:
    ...
    workspace: {
      ...
      description:
        "Erstellen Sie Ihren ersten Workspace und starten Sie AnyZearch.",
    },
  },
  common: {
  ...
  welcomeMessage: {
    part1:
      "Willkommen bei AnyZearch, AnyZearch ist ein Open-Source-KI-Tool von Mintplex Labs, das alles in einen trainierten Chatbot verwandelt, den Sie abfragen und mit dem Sie chatten können. AnyZearch ist eine BYOK-Software (Bring-Your-Own-Keys), daher gibt es keine Abonnements, Gebühren oder Kosten für diese Software außerhalb der Dienste, die Sie damit nutzen möchten.",
    part2:
      "AnyZearch ist der einfachste Weg, leistungsstarke KI-Produkte wie OpenAI, GPT-4, LangChain, PineconeDB, ChromaDB und andere Dienste in einem übersichtlichen Paket ohne Aufwand zusammenzufassen, um Ihre Produktivität um das 100-fache zu steigern.",
    part3:
      "AnyZearch kann vollständig lokal auf Ihrem Computer mit geringem Overhead laufen - Sie werden nicht einmal bemerken, dass es da ist! Keine GPU erforderlich. Cloud- und On-Premises-Installation ist ebenfalls verfügbar.\nDas KI-Tool-Ökosystem wird jeden Tag leistungsfähiger. AnyZearch macht es einfach, es zu nutzen.",
  ...
  "main-page": {
    ...
    checklist: {
      ...
      completed: "Sie sind auf dem Weg, ein AnyZearch-Experte zu werden!",
      dismiss: "schließen",
      tasks: {
        create_workspace: {
  ...
  general: {
    ...
    message: {
      ...
      heading: "Erkläre mir",
      body: "die Vorteile von AnyZearch",
    },
    pfp: {
  ...
  customization: {
    interface: {
      ...
      description: "Passen Sie die Benutzeroberfläche von AnyZearch an.",
    },
    branding: {
      title: "Branding & Whitelabeling",
      description:
        "Individualisieren Sie Ihre AnyZearch-Instanz durch eigenes Branding.",
    },
    chat: {
      title: "Chat",
      description: "Passen Sie Ihre Chat-Einstellungen für AnyZearch an.",
      auto_submit: {
    ...
    items: {
      ...
      "welcome-messages": {
        ...
        user: "Benutzer",
        message: "Nachricht",
        assistant: "AnyZearch Chat-Assistent",
  ...
  api: {
    title: "API-Schlüssel",
    description:
      "API-Schlüssel ermöglichen es dem Besitzer, programmatisch auf diese AnyZearch-Instanz zuzugreifen und sie zu verwalten.",
  ...
  llm: {
    title: "LLM-Präferenz",
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für Ihren bevorzugten LLM-Chat- und Einbettungsanbieter. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind, sonst wird AnyZearch nicht richtig funktionieren.",
  ...
  transcription: {
    ...
    "warn-start":
      "Die Verwendung des lokalen Whisper-Modells auf Maschinen mit begrenztem RAM oder CPU kann AnyZearch bei der Verarbeitung von Mediendateien zum Stillstand bringen.",
    "warn-recommend":
  ...
  embedding: {
    ...
    "desc-end":
      "Einbettung ist der Prozess, Text in Vektoren umzuwandeln. Diese Anmeldeinformationen sind erforderlich, um Ihre Dateien und Prompts in ein Format umzuwandeln, das AnyZearch zur Verarbeitung verwenden kann.",
    provider: {
  ...
  vector: {
    ...
    description:
      "Dies sind die Anmeldeinformationen und Einstellungen für die Funktionsweise Ihrer AnyZearch-Instanz. Es ist wichtig, dass diese Schlüssel aktuell und korrekt sind.",
    provider: {
  ...
  privacy: {
    ...
    description:
      "Dies ist Ihre Konfiguration dafür, wie verbundene Drittanbieter und AnyZearch Ihre Daten behandeln.",
    llm: "LLM-Auswahl",
  ...
  connectors: {
    ...
    upload: {
      ...
      "privacy-notice":
        "Diese Dateien werden zum Dokumentenprozessor hochgeladen, der auf dieser AnyZearch-Instanz läuft. Diese Dateien werden nicht an Dritte gesendet oder geteilt.",
    },
    pinning: {
  ...
  security: {
    ...
    password: {
      ...
      description:
        "Schützen Sie Ihre AnyZearch-Instanz mit einem Passwort. Wenn Sie dieses vergessen, gibt es keine Wiederherstellungsmethode, also stellen Sie sicher, dass Sie dieses Passwort speichern.",
