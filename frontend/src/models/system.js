...
const System = {
  cacheKeys: {
    footerIcons: "AnyZearch_footer_links",
    supportEmail: "AnyZearch_support_email",
    customAppName: "AnyZearch_custom_app_name",
    canViewChatHistory: "AnyZearch_can_view_chat_history",
    deploymentVersion: "AnyZearch_deployment_version",
  },
  ping: async function () {
