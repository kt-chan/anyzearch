# How to deploy a private AnyZearch instance on AWS
...
5. Use the file `cloudformation_create_AnyZearch.json` as your JSON template.
...
```
[+] Running 2/2
 ⠿ Network docker_AnyZearch  Created 
 ⠿ Container AnyZearch       Started  
```
